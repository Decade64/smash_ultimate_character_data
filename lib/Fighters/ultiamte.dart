...
List<Fighter> ultimate(){
  ...
  ultimate.add(Fighter(
    ...
    discordLink: "https://discord.com/invite/jCBrxZX",
  ...
  ultimate.add(Fighter(
      ...
      discordLink: "https://discord.com/invite/3UJwxAh",
  ...
  ultimate.add(Fighter(
      ...
      discordLink: "https://discord.com/invite/yHRz4fG",
  ...
  ultimate.add(Fighter(
      ...
      discordLink: "https://discord.com/invite/Xqrchru",
  ...
  ultimate.add(Fighter(
      ...
      discordLink: "https://discord.com/invite/5FKHpgn",
  ...
  ultimate.add(Fighter(
      ...
      stockIconGraphOffset: Offset(0,0),
      barColor: Colors.red,
      discordLink: "https://discord.com/invite/3DDQ9tQ",
  ...
  ultimate.add(Fighter(
      ...
      discordLink: "https://discord.com/invite/Pvwkbt8",
  ...
  ultimate.add(Fighter(
      ...
      discordLink: "https://discord.com/invite/Sf6EZuQ",
  ...
  ultimate.add(Fighter(
      ...
      stockIconGraphOffset: Offset(0,0),
      barColor: Colors.brown,
      discordLink: "https://discord.com/invite/gBhBsfm",
  ...
  ultimate.add(Fighter(
      ...
      stockIconGraphOffset: Offset(0,0),
      barColor: Colors.red,
      discordLink: "https://discord.com/invite/KDgVmbA",
  ...
  ultimate.add(Fighter(
      ...
      discordLink: "https://discord.com/invite/P4U9ehx",
